...
display = {};
	display.initiate = function () {
		...
		display.timesup = document.getElementById('timesup');
...
button2 = document.getElementById("close1");
button3 = document.getElementById("close2");
button4 = document.getElementById("close4");
